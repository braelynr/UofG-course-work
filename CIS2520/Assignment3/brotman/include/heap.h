 ...
 *@param compare function pointer to a function that compares two pieces of data.
 *@param destroyData function pointer to a function to delete a single piece of data from the heap
 *@param printNode function pointer to a function that prints out a data element of the heap
 *@return pointer to the heap
 **/
