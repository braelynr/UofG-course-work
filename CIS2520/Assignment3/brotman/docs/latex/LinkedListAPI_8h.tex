...
\item 
\hyperlink{structNode}{Node} $\ast$ \hyperlink{LinkedListAPI_8h_a1f97560bb77496690b9bb600c9d793ee}{initialize\+Node} (void $\ast$data)
\item 
...
{\footnotesize\ttfamily typedef struct \hyperlink{structlistNode}{list\+Node}  \hyperlink{structNode}{Node}}
...
{\footnotesize\ttfamily \hyperlink{structNode}{Node}$\ast$ initialize\+Node (\begin{DoxyParamCaption}\item[{void $\ast$}]{data }\end{DoxyParamCaption})}
...
Inserts a \hyperlink{structNode}{Node} to the back of a linked list. The list then updates accordingly to adhere to the A\+DT. \begin{DoxyPrecond}{Precondition}
\textquotesingle{}List\textquotesingle{} type must exist and be used in order to keep track of the linked list. 
\end{DoxyPrecond}
...
Inserts a \hyperlink{structNode}{Node} to the front of a linked list. The list then updates accordingly to adhere to the A\+DT. \begin{DoxyPrecond}{Precondition}
\textquotesingle{}List\textquotesingle{} type must exist and be used in order to keep track of the linked list. 
\end{DoxyPrecond}
...
List exists and has memory allocated to it. \hyperlink{structNode}{Node} to be added is valid. 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
