...
\begin{DoxyCompactItemize}
\item 
\hyperlink{structHeap}{Heap} $\ast$ \hyperlink{heap_8h_ac5ef5caa7cdb34d9f1974b45da81368b}{create\+Heap} (size\+\_\+t initial\+Size, H\+E\+A\+P\+\_\+\+T\+Y\+PE htype, void($\ast$\hyperlink{hospital_8h_a57d4c229c1eaa2e9bbf21c266fb6e7d5}{destroy\+Data})(void $\ast$data), void($\ast$print\+Node)(void $\ast$to\+Be\+Printed), int($\ast$\hyperlink{hospital_8h_ab6692939eeb89d044d92061a6501e505}{compare})(const void $\ast$first, const void $\ast$second))
\item 
